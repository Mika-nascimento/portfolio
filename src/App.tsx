...
import { sections, features, siteConfig } from '@/config/loader'
...
function PortfolioView() {
  ...
  // The static index.html is generated from the Portuguese config, so keep the
  // document language and title in sync when English is the active language.
  useEffect(() => {
    document.documentElement.lang = siteConfig.meta.language
    document.title = siteConfig.meta.title
    document
      .querySelector('meta[name="description"]')
      ?.setAttribute('content', siteConfig.meta.description)
  }, [])
