...
import siteEnJson from './site.en.json'
import contentJson from './content.json'
import contentEnJson from './content.en.json'
...
// Pick the config variant for the active language. Resolved once, at module
// load, so every component below sees a single consistent language.
const activeSiteJson = currentLanguage === 'en' ? siteEnJson : siteJson
const activeContentJson = currentLanguage === 'en' ? contentEnJson : contentJson

export const siteConfig: SiteConfig = validateSiteConfig(activeSiteJson)

const rawContentConfig: ContentConfig = validateContentConfig(activeContentJson)
