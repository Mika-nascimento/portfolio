...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="portfolio-hero relative min-h-screen flex items-start md:items-center pt-24 md:pt-26 lg:pt-20 overflow-hidden"
    >
      {/* Subtle background pattern */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 portfolio-hero-surface" />
        <div
      ...
      <div className="container-wide">
        <div className="flex flex-col md:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-16 items-center md:items-start lg:items-center">
          ...
          <div className="order-last md:order-first md:flex-[1.5] space-y-6 md:space-y-4 lg:space-y-6">
            ...
            {hero.statusBadge && (
              <div className="portfolio-status animate-fade-in-up inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted border border-border">
                <span
                  className={
            ...
            <div className="space-y-4">
              <h1 className="portfolio-name animate-fade-in-up stagger-1 headline-editorial text-navy-950 dark:text-slate-50">
                {hero.name}
              </h1>
              <p className="portfolio-role animate-fade-in-up stagger-2 text-2xl md:text-3xl lg:text-4xl font-display font-medium text-brass-600 dark:text-brass-400">
                {hero.title}
              </p>
            </div>
          ...
          <div className="order-first md:order-last flex justify-center md:justify-end md:flex-1">
            <div className="animate-scale-in stagger-2 relative">
              ...
              {hero.badge && (
                <div className="mt-4 sm:mt-0 sm:absolute sm:-bottom-2 sm:-left-2 md:bottom-4 md:-left-6 lg:-left-8 bg-card rounded-xl shadow-lg px-3 py-2 sm:px-4 sm:py-3 border border-border max-w-[18rem]">
